...
class SystemLogicController {
  ...
  private func showSystemPreferencesDialog(handler completion : (Bool)->Void) {
    ...
    alert.informativeText = "For noctOs to work properly, you will have to enable Accessibility. You can do this by adding it in System Preferences, Security & Privacy, Privacy.".localized
